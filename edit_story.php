...
// Query character details along with their concatenated story IDs
...
<body>
    ...
    <a href="manage_story.php">Back</a>

    <form action="action/update_story.php" method="POST">
        <input type="hidden" name="char_id" value="<?= $row['char_id'] ?>">
        ...
        <label>Height:</label>
        <input type="number" name="height" value="<?= $row['height'] ?>"><br>

        <label>Hobby:</label>
        <input type="text" name="hobby" value="<?= $row['hobby'] ?>"><br>
